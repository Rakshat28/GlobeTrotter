...
        <TrustedBy />
        <BenefitsSection />
        <BigPictureSection onDiscoverMore={handleDiscoverMore} />
        <SpecsSection />
        <TestimonialSection />
        <HowToSection onDiscoverMore={handleDiscoverMore} />
        <ContactCTA />
      </main>
      <SiteFooter />
    </div>
...
function BigPictureSection({ onDiscoverMore }: { onDiscoverMore: () => void }) {
  const bullets = [
...
          </ul>
          <div className="pt-2">
            <Button className="gap-2" onClick={onDiscoverMore}>Discover More <ArrowRight className="size-4" /></Button>
          </div>
        </div>
      </div>
    </section>
...
function HowToSection({ onDiscoverMore }: { onDiscoverMore: () => void }) {
  const steps = [
